...
class Student:
    ...
    def __init__(self, id): #constructer used to initialize the attributes of the class.
        self.id = id
...
if n <= 0:
    ...
    print("Iterative Distribution:") #print itertaive distribution
...
#print recrusive distribution
    ...
    target_price = 16  # The target price you're searching for
    attribute_price = 'price'  # Searching by 'price'

    target_weight = 9  # The target weight you're searching for
    ...
    # Printing results
    print("\n")
    if found_student_price:# If a student with the specified price is found, print their information
    ...
    else:# If no student with the specified price is found, print a message
        print(f"No student found holding a chocolate with {attribute_price} {target_price} AED.")

    if found_student_weight:# If a student with the specified weight is found, print their information
    ...
    else:# If no student with the specified weight is found, print a message
